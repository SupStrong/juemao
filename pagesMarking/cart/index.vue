<template>
	<view :style="colorStyle">
		<view class="shoppingCart copy-data">
			...
			<!-- <view v-if="(cartList.valid.length > 0 || cartList.valid.length > 0) && canShow"> -->
				<view class="list">
							...
							<view class="item acea-row row-between-wrapper">
								...
								<navigator :url="'/pages/goods_details/index?id=' + item.product_id" hover-class="none" class="picTxt acea-row row-between-wrapper">
									...
									<view class="carnum acea-row row-center-wrapper" v-if="item.attrStatus">
										...
										<view class="num"><input type="number" v-model="item.cart_num" @click.stop @input="iptCartNum(index)" @blur="blurInput(index)" /></view>
			...
			<view class="footer acea-row row-between-wrapper">
				...
				<view class="money acea-row row-middle" v-if="footerswitch == true">
					...
					<form @submit="subOrder"><button class="placeOrder bg-color" formType="submit">立即下单</button></form>
				</view>
				<view class="button acea-row row-middle" v-else>
					<form @submit="subCollect"><button class="bnt cart-color" formType="submit">收藏</button></form>
					<form @submit="subDel"><button class="bnt" formType="submit">删除</button></form>
				</view>
			</view>
		</view>
		...
		<view class="foot" v-if="is_diy && newData.status && newData.status.status">
			<view class="page-footer" id="target" :style="{ 'background-color': newData.bgColor.color[0].item }">
				<view class="foot-item" v-for="(item, index) in newData.menuList" :key="index" @click="goRouter(item)">
					...
					<div class="count-num" v-if="item.link === '/pages/order_addcart/order_addcart' && cartCount > 0">{{ cartCount }}</div>
				</view>
			</view>
		</view>
	</view>
...
let sysHeight = 0;
// #endif
import { getCartList, getCartCounts, changeCartNum, cartDel, getResetCart } from '@/api/modules/order.js';
import { getProductHot, collectAll, getProductDetail } from '@/api/modules/store.js';
// import {
// 	toLogin
// } from '@/libs/login.js';
...
export default {
				...
				valid: [
					{
						...
						productInfo: {
							id: 119,
							mer_id: 0,
							image: 'https:\/\/demo26.crmeb.net\/uploads\/attach\/2021\/12\/10\/small_738c68638ab29effeff2e98365ec6dd6.jpg',
							recommend_image: 'https:\/\/demo26.crmeb.net\/uploads\/attach\/2022\/03\/20220329\/3aa5f52c894d64860156502b23db300a.jpg',
							slider_image: [
								'https:\/\/demo26.crmeb.net\/uploads\/attach\/2021\/12\/10\/738c68638ab29effeff2e98365ec6dd6.jpg',
								'https:\/\/demo26.crmeb.net\/uploads\/attach\/2021\/12\/10\/a0754782441aeb2672aa5d29ef8285c3.jpg',
								'https:\/\/demo26.crmeb.net\/uploads\/attach\/2021\/12\/10\/4de2e9ddea870d01cd228b250f27914d.jpg',
								'https:\/\/demo26.crmeb.net\/uploads\/attach\/2021\/12\/10\/3257c43eaceac2357b9bfb46667fd10d.jpg',
								'https:\/\/demo26.crmeb.net\/uploads\/attach\/2021\/12\/10\/0652e910b74cd8704845af86adb82fe1.jpg'
							],
							...
							spu: '4898545158259',
							label_id: '',
							video_link: 'https:\/\/cloud.video.taobao.com\/play\/u\/2067791393\/p\/2\/e\/6\/t\/1\/336857169053.mp4',
							command_word: '',
							recommend_list: '',
							vip_product: 0,
							presale: 0,
	...
	onShow() {
		...
		if (this.isLogin == true) {
			this.hotPage = 1;
			(this.hostProduct = []), (this.hotScroll = false), this.getHostProduct();
			this.loadend = false;
			this.page = 1;
			this.cartList.valid = [];
			this.getCartList();
