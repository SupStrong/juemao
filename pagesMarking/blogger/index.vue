<template>
	<view class="template-bless tn-safe-area-inset-bottom">
		...
		<view class="tabbar footerfixed">
			<view class="action" @click="navTuniaoUI(item)" :class="{ 'bar-center': item.isHome }" v-for="(item, index) of tabbar.list" :key="index">
				<!-- 小tabbar -->
				<view class="" v-if="item.isHome != true">
			<view class="bar-icon"><image class="" :src="item.activeIcon"></image></view>
					<tn-badge
						v-if="item.num"
						:dot="false"
			 ...
			 list: [
				 {
						...
						inactiveIcon: 'https://tnuiimage.tnkjapp.com/bless/bless-home.png',
						num: '120',
						path: ''
					},
					{
						...
						inactiveIcon: 'https://tnuiimage.tnkjapp.com/bless/bless-flower.png',
					 num: '40',
					 path: ''
					},
					{
					...
					},
					{
						...
						inactiveIcon: 'https://tnuiimage.tnkjapp.com/bless/bless-china.png',
						path: ''
					},
					{
						title: '我的',
						activeIcon: 'https://tnuiimage.tnkjapp.com/bless/bless-money.png',
					 inactiveIcon: 'https://tnuiimage.tnkjapp.com/bless/bless-money.png',
						path: ''
					}
				]
			}
